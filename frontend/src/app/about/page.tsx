      ...
      <div className="flex-grow pt-28 md:pt-32 pb-16 px-5 sm:px-8 md:px-10 lg:px-16 max-w-3xl mx-auto w-full space-y-12">
        ...
        >
          ...
          <p className="text-text-secondary text-base md:text-lg leading-relaxed">
            Z-Combinators is a structured evaluation tool for startup ideas. It applies frameworks from Y Combinator, Andreessen Horowitz, and NFX to give you cited, dimension-level feedback on your idea -- not a verdict on whether it will succeed.
          </p>
        </motion.div>

        {/* What Z-Combinators Is / Is Not Grid */}
