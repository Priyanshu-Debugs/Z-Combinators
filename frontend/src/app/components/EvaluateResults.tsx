  ...
  return (
    <div className="w-full space-y-8">
      ...
      <motion.div
        ...
        className="w-full p-4 sm:p-6 rounded-2xl border bg-surface/40 backdrop-blur-xl shadow-[0_8px_30px_rgb(0,0,0,0.02)] border-border flex flex-col items-center justify-center min-h-[320px] sm:min-h-[350px] relative overflow-hidden transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)]"
      >
        {/* Overall Score with ring */}
        <div className="w-full sm:absolute sm:top-5 sm:left-6 flex flex-col sm:flex-row items-center sm:items-start space-y-2 sm:space-y-0 sm:space-x-3 text-center sm:text-left mb-6 sm:mb-0">
        ...
        <div className="w-full pt-2 sm:pt-8 flex items-center justify-center">
