...
export default function Disclaimer() {
  ...
  return (
    <div
      className={`w-full border-t px-5 sm:px-8 text-center transition-all duration-300 ${
        isEvaluate ? "py-2.5" : "py-4"
      }`}
      style={{
    ...
    >
      <p
        className={`max-w-2xl mx-auto leading-relaxed transition-all duration-300 ${
          isEvaluate ? "text-[11px]" : "text-[13px]"
        }`}
